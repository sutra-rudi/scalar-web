...
export default function AppFooter() {
  ...
  return (
    <footer className='w-full overflow-hidden bg-primary-dark dark:bg-secondary-dark py-12 relative before:absolute before:w-[300%] before:h-[300%] before:inset-0 before:bg-sutraNoiseBg before:opacity-5 before:bg-no-repeat before:bg-center before:bg-cover before:pointer-events-none before:select-none before:animate-animateFilm before:will-change-transform'>
